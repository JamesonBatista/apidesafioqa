  ...
  paths: {
    "/json_1": {
      get: {
        ...
        description:
          "1 - Verificar que todos os nomes dentro do array de objetos no arrayDeObjetos começam com letra maiúscula e que os valores sejam todos positivos.",
        responses: {
          200: {
    ...
    "/json_2": {
      get: {
        ...
        description:
          "2 - Desafio de Validação Assegurar que todas as datas em historicoDePedidos estejam no formato YYYY-MM-DD e que nenhum precoTotal exceda a soma dos preços dos produtos multiplicados pela quantidade.",
        responses: {
          200: {
    ...
    "/json_3": {
      get: {
        ...
        description:
          "3 - Desafio de Validação Garantir que o veiculoLancadorId em cada satelites e missoes corresponda a um id válido dos veiculosLancadores e que todos os status estejam dentro dos valores permitidos ['ativo', 'inativo', 'planejado', 'em preparação', 'concluído'].",
        responses: {
          200: {
